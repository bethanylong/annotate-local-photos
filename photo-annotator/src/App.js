...
class PictureDetails extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            locate: this.props.details.locate || "",
    ...
    render() {
        return (
            <div className="picture-details-grid">
                ...
                <span>Location:</span> <textarea className="small-textarea" name="locate" autoComplete="off" value={this.state.locate} onChange={this.handleChange} />
                <span>Tags:</span> <textarea className="small-textarea" name="tags" autoComplete="off" value={this.state.tags} onChange={this.handleChange} />
            </div>
        );
    }
}
...
class App extends React.Component {
    ...
    async saveDetails() {
        ...
        this.setState({dirtyDetails: false});
    }
